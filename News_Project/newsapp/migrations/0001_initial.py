# Generated by Django 4.0.4 on 2022-05-13 02:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('categoryType', models.CharField(choices=[('NW', 'Новость'), ('AR', 'Статья'), ('DG', 'Дайджест')], default='AR', max_length=2, verbose_name='Категория поста')),
